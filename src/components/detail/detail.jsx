...
const Detail = (props) => {
  ...
  return (
	...
	<div class="ftco-section ftco-car-details">
      <div class="container">
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" >
                      <img alt='' src={props.data.img} width="100%" height="500px"></img>
</div>
      	...
      	<div class="row">
      		<div class="col-sm-2 d-flex align-self-stretch ftco-animate">
          ...
          <div class="col-sm-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services">
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
